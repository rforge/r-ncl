...
\item I've put a few other functions functions that I use online
\begin{center}
\url{http://goo.gl/nf82zX}
\end{center}
feel free to use them. Also take a look at this stackoverflow question
\begin{center}
