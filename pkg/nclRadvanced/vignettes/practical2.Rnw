...
# if(!show) {
#   fname_solutions = gsub("practical", "solutions", fname)
#   cmd = paste("cp", fname, fname_solutions)
#   system(cmd)
# }
...
\title{Advanced R programming: \Sexpr{ifelse(show, "solutions","practical")}  2} 
...
<<echo=show, results=results, message=FALSE>>=
